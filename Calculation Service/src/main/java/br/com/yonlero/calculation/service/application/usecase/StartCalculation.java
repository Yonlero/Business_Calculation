...
public class StartCalculation {
    ...
    private final FindBudgetOpening budgetOpeningService;
    ...
    public Calculation startCalculation(LocalDate startDate, LocalDate endDate, UUID userId) throws JsonProcessingException {
        ...
        // Ignore return because it's in cache now
        budgetOpeningService.findBudgetOpeningToCalculate(YearMonth.from(startDate), YearMonth.from(endDate));
